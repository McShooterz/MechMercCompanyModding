...
public class PostProcessingSobelOutline : PostProcessEffectSettings
{
...
public sealed class SobelOutlineRenderer : PostProcessEffectRenderer<PostProcessingSobelOutline>
{
    public const string SobelShader = "Custom/PostProcessingSobelOutline";
