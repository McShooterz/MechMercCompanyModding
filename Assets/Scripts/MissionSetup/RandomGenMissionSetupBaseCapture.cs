...
public class RandomGenMissionSetupBaseCapture : RandomGenMissionSetupAbstract
{
    ...
    public override void DrawGizmos()
    {
        ...
        DrawTurretSpawnPointsEnemyGizmos(spawnPointsTurret);

        DrawBaseSpawnPointsNeutralGizmos(new GameObject[] { spawnPointBase });
    }
